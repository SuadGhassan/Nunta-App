...
import 'package:nunta_app/screens/wlcome_screens/pay_and_userAccount/user_account_screen.dart';
...
class SettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigateBar(selectedMenu: MenuState.More),
      body: Stack(
        children: [
          Container(
               ...
               child: Column(
                 ...
                 children: [
                   Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context){return UserAcoountScreen();}));

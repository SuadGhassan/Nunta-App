...
class UserAcoountScreen extends StatefulWidget {
  static const routeName = '/User_Account_Page';
  const UserAcoountScreen({Key key}) : super(key: key);

  @override
  _UserAcoountScreenState createState() => _UserAcoountScreenState();
}

class _UserAcoountScreenState extends State<UserAcoountScreen> {
  ...
  Future<void> editAccountInfo() async {
    ...
    if (response != null && response['status'] == "success") {
      ...
      return ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(backgroundColor: Colors.red[900],content: SnackBarText("Account info has been updated")));
    } else {

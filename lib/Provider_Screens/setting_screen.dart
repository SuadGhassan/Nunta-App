...
import 'package:nunta_app/Provider_Screens/provider_account.dart';
...
class ProviderSetting extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: ProviderNavBar(selectedMenu: MenuState.providerMore,),
      body: Stack(
        children: [
          Container(
               ...
               child: Column(
                 ...
                 children: [
                   Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context){return ProviderAccount();}));
